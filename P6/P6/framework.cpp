...
//My own classes and operators

void Vector1x4::calculateBernstein(float t)
{
	this->B1 = powf(1-t,3);
	this->B2 = 3*t*powf(1-t,2);
	this->B3 = 3*powf(t,2)*(1-t);
	this->B4 = powf(t,3);
}

Vector1x4::Vector1x4()
{
	this->B1 = this->B2 = this->B3 = this->B4 = 0.0f;
}

VectorPoints4x1::VectorPoints4x1()
{
	//No hacemos nada
}

VectorPoints4x1::VectorPoints4x1(Vector3 &point1, Vector3 &point2, Vector3 &point3, Vector3 &point4)
{
	this->P1 = point1;
	this->P2 = point2;
	this->P3 = point3;
...
{
	return (a.B1 * b.P1) + (a.B2 * b.P2) + (a.B3 * b.P3) + (a.B4 * b.P4);
}
