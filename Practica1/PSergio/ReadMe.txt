========================================================================
    APLICACIÓN DE CONSOLA: PSergio Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación PSergio.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la PSergio aplicación.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado PSergio.pch y un archivo de 
